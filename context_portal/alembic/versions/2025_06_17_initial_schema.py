...
def upgrade() -> None:
    ...
    if 'active_context' not in tables:
    ...
    if 'active_context_history' not in tables:
    ...
    if 'context_links' not in tables:
    ...
    if 'product_context' not in tables:
    ...
    if 'product_context_history' not in tables:
    ...
    if 'system_patterns' not in tables:
